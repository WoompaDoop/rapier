...
#[repr(transparent)]
pub struct RigidBodyHandle(pub crate::data::cool_map::CoolKey);
...
impl RigidBodyHandle {
    ...
    pub fn from_raw_parts(key: u32, index: u32) -> Self {
        Self(crate::data::cool_map::CoolKey::from_raw_parts(key, index))
    }
